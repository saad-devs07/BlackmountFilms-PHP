            ...
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-7 p-4 mb-0">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <button class="btn btn-dark px-4" type="submit" name="login">Login</button>
                    </div>
              ...
              <div class="card col-md-5 text-white bg-dark py-5">
                <div class="card-body text-center">
                  <div>
                    ...
                    <a href="register.php" class="btn btn-lg btn-outline-light mt-3" type="submit">Register Now!</a>
                  </div>
                </div>
              </div>
