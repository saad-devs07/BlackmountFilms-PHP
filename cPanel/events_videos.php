    ...
    <div class="card-header">
      <div class="row">
        ...
        <div class="col-md-2 mt-1">
          <button class="btn btn-sm btn-dark" type="button" data-coreui-toggle="modal" data-coreui-target="#add_photo">Add new video</button>
        </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLiveLabel">Update Photo</h5>
      ...
      <div class="modal fade" id="add_photo" data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="staticBackdropLiveLabel">Add new video</h5>
              <button class="btn-close" type="button" data-coreui-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body">
              <form action="../coding.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <input class="form-control" type="text" name="video_name" placeholder="Enter Video Name">
                </div>
                
                <div class="mb-3">
                  <input class="form-control" type="textarea" name="video_desc" placeholder="Description">
                </div>
                
                <div class="mb-3">
                  <input class="form-control" type="file" id="formFile" name="upload_video">
                </div>

                <div class="modal-footer">
                  <button class="btn btn-secondary" type="button" data-coreui-dismiss="modal">Close</button>
                  <button class="btn btn-dark" type="submit" name="add_video">Add & Close</button>
                </div>
